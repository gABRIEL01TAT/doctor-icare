...
urlpatterns = [
    ...
    path('save_drug_search', views.save_drug_search, name='save_drug_search'),
    path('save_pharmacy_selection', views.save_pharmacy_selection, name='save_pharmacy_selection'),
    ...
    path('disease_views', views.disease_views, name="disease_views"),
